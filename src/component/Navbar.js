...
export default function Navbar() {
  return (
    <div className="flex flex-row w-[1536px] h-[58px] left-0 top-0 gap-[69px]  items-center absolute">
      <h1 className="text-[#EEEEEE] text-[28px] left-[12px] relative">
        My Porfolio
      </h1>
      <ul className="flex flex-row gap-[26px]  items-center relative top-[3.5px]">
      ...
      <a href="/" className="flex flex-row items-center pt-[10px] pl-[20px] w-[109px] h-[39px] bg-[#00ADB5] rounded-[24px] left-[687px] relative">
